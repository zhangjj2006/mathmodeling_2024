...
#         # 绘制堆叠直方图
#         # if stacked_data:
#         #     n, bins, patches = ax1.hist(stacked_data, bins=20, stacked=True, 
...
#         # 保存图表
#         plt.savefig(f'./python_code/BMI_{bmi_cat.replace("<", "lt").replace(">", "gt")}_stacked_distribution.png', 
#                    dpi=300, bbox_inches='tight')
#         plt.close()
...
#     # 保存图表
#     plt.savefig('./python_code/BMI_all_intervals_stacked_distribution.png', 
#                dpi=300, bbox_inches='tight')
#     plt.close()
