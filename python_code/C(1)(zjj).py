...
def best_bmi_Y():  # 将y染色体达标时候的孕妇bmi挑出来
    ...
    for patient_id in df_filtered['孕妇代码'].unique():
        ...
        # if slope > 0 :
            ...
            days_change = last_bmi_record['检测孕周_天数'] - first_bmi_record['检测孕周_天数']
            ...
            if days_change != 0:
                ...
                normalized_bmi_growth_rate = bmi_growth_rate / first_bmi_record['孕妇平均BMI']
            else:
                bmi_growth_rate = 0
    ...
    # 保存结果到Excel文件
    df_result.to_excel('./python_code/Week_Y_BMI_0.04_result.xlsx', index=False)
